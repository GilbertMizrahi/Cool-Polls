...
export default class App extends TrackerReact(Component) {
  constructor() {
    ...
    this.state = {
      subscription: {
        pollsData: Meteor.subscribe('userPolls', {sort: {createdAt: -1}, limit: POLLS_PER_PAGE * pageNumber.get()})
      }
    }
  }
  ...
  pollsData() {
    Meteor.subscribe('userPolls', {sort: {createdAt: -1}, limit: POLLS_PER_PAGE * pageNumber.get()})
  ...
  showMoreButton() {
    Meteor.call('polls.totalPolls', function(error, result){
