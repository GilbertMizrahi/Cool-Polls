...
import {EmbedLayout} from '../imports/ui/layouts/embedLayout.jsx';
...
import PostedPollContainer from '../imports/ui/containers/postedPollContainer.js';
...
FlowRouter.route('/poll/:id', {
  ...
  action(id) {
    mount(EmbedLayout, {
      content: (<PostedPollContainer {...id} />)
    })
  }
});
